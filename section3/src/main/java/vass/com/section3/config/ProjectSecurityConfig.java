package vass.com.section3.config;
...
public class ProjectSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails admin = User.withUsername("admin")
                .password("{bcrypt}$2a$12$d8ZGzWkWfqYFgXqyKtVwQ.l0ZTOXQoN7LYREuA17FVkuSvUOzf96a")
                .authorities("admin").build();
        /*
         * Password generate from https://bcrypt-generator.com/ EazyBytes@12348
         * @return
         */
